...
class TelaEfeitos(QMainWindow): # carrega tela dos efeitos
    ...
    def botao_ligar(self):
        ...
        self.process_audio(input_device=1, output_device=3,  chorus_rate=self.razao, compressor_threshold=self.compressor, distortion_amount=self.distorcao, gain_db=self.ganho, delay_time=self.delay, pitch_shift_semitones=self.pitch)
