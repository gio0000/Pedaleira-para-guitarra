#precisa instalar o pedarboard (pip install pedalboard)
...
def janela():
    janela = tk.Tk()
    janela.title("Pedaleira JAV 1.0")
...
def audio_processing():
    ...
    buffer= 256 # Smaller buffer size for lower latency
...
#Criar função de gravação de audio